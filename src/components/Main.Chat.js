...
const MainChat = ({
        ...
        return (
          ...
          >
            {c.sentBy._id === user._id ? (
              ...
              >
                <Avatar
                  src={c && c.sentBy && c.sentBy.image ? c.sentBy.image : ""}
    ...
    return (
      <>
        ...
        <div className="relative">
          <div className="p-4 chat-messages flex flex-col"></div>
        </div>
      </>
    );
  }
  ...
  return (
    <>
      ...
      <div className="relative">
        <div
          className="chat-messages p-2 md:p-4 flex flex-col dark:bg-[#242526] h-[70vh] overflow-y-scroll rounded-lg "
          style={{ margin: "0 7px", border: "1px solid #d8d8d8" }}
        >
          {messBox()}
